...
// By using the path.dart library, we don't need to know how files are saved in the current operating system,
// and we can still access the database using the same code. ”
